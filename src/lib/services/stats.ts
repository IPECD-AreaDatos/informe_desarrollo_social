...
export interface SummaryData {
    ...
    topMunicipios: Array<{ name: string; value: number }>;
    recent: Array<{ type: string; detail: string; date: string; location: string }>;
}

export async function getSummaryStats(from: string, to: string): Promise<SummaryData> {
    ...
    `, [from, to]);
        ...
        return {
            ...
            topMunicipios: topMunicipios as any[],
